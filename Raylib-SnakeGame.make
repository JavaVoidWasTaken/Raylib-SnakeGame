...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/Raylib-SnakeGame
OBJDIR = obj/x64/Debug/Raylib-SnakeGame
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/Raylib-SnakeGame
OBJDIR = obj/x86/Debug/Raylib-SnakeGame
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/Raylib-SnakeGame
OBJDIR = obj/ARM64/Debug/Raylib-SnakeGame
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/Raylib-SnakeGame
OBJDIR = obj/x64/Release/Raylib-SnakeGame
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/Raylib-SnakeGame
OBJDIR = obj/x86/Release/Raylib-SnakeGame
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/Raylib-SnakeGame
OBJDIR = obj/ARM64/Release/Raylib-SnakeGame
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
clean:
	@echo Cleaning Raylib-SnakeGame
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
